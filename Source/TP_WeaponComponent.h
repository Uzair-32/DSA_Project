...
// Forward declaration of the FPS character class
class AFpsCharacter;

/**
 * UTP_WeaponComponent:
 * A component for managing weapon behavior for a First Person Character.
 * Handles shooting, reloading, ammo tracking, sound effects, and visual FX.
 */
...
protected:
    ...
    /** Ammo in the weapon's clip */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Ammo")
	int m_iClipSize = 8;
    /** Maximum ammo that can be held */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Ammo")
	int m_iMaxAmmo = 80;
    /** Current ammo in the magazine */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Ammo")
	int m_iCurrentAmmo = 0;
    /** Ammo held in reserve (holstered) */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Ammo")
	int m_iHolsteredAmmo = 0;

private:
    /** Pointer to the character holding this weapon */
